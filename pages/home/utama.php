<div id="content" class="content">
	...
	<div class="row">
		<?php
		$t_pasien = $db->query('SELECT COUNT(*) AS total_pasien FROM tb_soap');
					...
					<div class="row">
						<div class="col-xl-7 col-lg-8">
							...
							<div class="d-flex mb-1">
								<h2 class="mb-0"><span data-animation="number" data-value="
																							<?php
																							if ($pow['total_pasien']==NULL) {
																								echo "0";
																							}else{
																								echo $pow['total_pasien'];
																							}
																							?>
																						  ">0.00</span></h2>
					...
					<div class="panel-body">
						<table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
							...
							<tbody>
								...
								?>
								<tr>
									<!-- <td>php$row['id'] == NULL ? "<i><font style='color:red;'>Not Found</font></i>" : $row['id'] ?></td> -->
