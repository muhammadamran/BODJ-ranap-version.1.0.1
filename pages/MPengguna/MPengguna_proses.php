...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO tb_user 
                        ...
                        ("'.$username.'","'.$password.'","'.$NIK.'","'.$nama_lengkap.'","'.$tempat_lahir.'","'.$tgl_lahir.'","'.$agama.'","'.$jenis_kelamin.'","'.$status_pernikahan.'","'.$status_pegawai.'","'.$jabatan.'","'.$email.'","'.$alamat.'","'.$telepon.'","'.$role.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index.php?m=MPengguna&s=MPengguna"</script>';
    } else {
...
// PROSES DATA UPDATE
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index.php?m=MPengguna&s=MPengguna"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index.php?m=MPengguna&s=MPengguna"</script>';
    } else {
...
// PROSES CHANGE PASSWORD
    ...
    if ($change) {
        echo '<script>alert("Password berhasil diganti");location.href = "../../index.php?m=MPengguna&s=MPengguna"</script>';
    } else {
