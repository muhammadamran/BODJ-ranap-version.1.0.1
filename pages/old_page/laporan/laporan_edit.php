        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                <div class="panel-heading">
                    <h4 class="panel-title">BODJ Rawat Inap <button class="btn btn-xs btn-warning"><?php echo $row['tgl_jaga']; ?></button><br><hr> Oleh Dokter <button class="btn btn-xs btn-warning"><?php echo $row['dokter_jaga']; ?></button></h4>
                    ...
                    <div class="form-horizontal form-bordered">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <?php }else{ ?>
                                        <img src="<?php echo 'assets/uploads/object/'. $row['berkas'];?>" alt="" />   
                                <?php } ?>
                            </div>
                        </div>
                        <hr>
