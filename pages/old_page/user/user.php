      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a href="index.php?m=user&s=user_add" class="btn btn-icon btn-sm btn-inverse"><i class="fa fa-plus-square"></i></a>
          </h4>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                          <div class="image" align="center">
                              <?php
                              if ($row['foto']==NULL) { ?>
                                  <img src="assets/img/user/user-13.png" alt="" class="lingkaran" />   
                              <?php }else{ ?>
