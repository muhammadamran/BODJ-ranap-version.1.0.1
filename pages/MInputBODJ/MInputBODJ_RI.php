        ...
        <div class="min-height-200px">
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    ...
                    <hr>
                    <a href="index.php?m=MInputBODJ&s=MInputBODJ_add_RI" class="btn btn-outline-primary">
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                $data = $db->query("SELECT * FROM tb_soap WHERE dokter_jaga='$sesi' AND no_rm !='' AND instalasi='Rawat Inap' ORDER BY tgl_jaga ASC", 0);
                                while($row = $data->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?m=MInputBODJ&s=MInputBODJ_edit_RI&id=<?= $row['id'] ?>"><span class="btn btn-light btn-sm"><i class="icon-copy ion-edit"></i> </span></a>
