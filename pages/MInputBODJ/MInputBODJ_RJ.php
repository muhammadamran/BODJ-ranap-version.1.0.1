    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <label>Berikut merupakan inputan SOAP dari BODJ Rawat Jalan yang dilakukan oleh masing-masing dokter pada pasien Rawat Jalan.</label> <br><hr>
                                    <label>Klik icon <button type="button" class="btn btn-outline-primary"><i class="icon-copy ion-plus-circled"></i></button> untuk menambahkan data SOAP Rawat Jalan</label><br>
                                    <label>Klik icon <button type="button" class="btn btn-light"><i class="icon-copy ion-edit"></i></button> untuk mengupdate data SOAP Rawat Jalan</label><br>
                                    ...
                                    <label>Klik icon <button type="button" class="btn btn-danger"><i class="icon-copy ion-trash-b"></i></button> untuk menghapus data SOAP Rawat Jalan</label>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="card-box mb-30">
                <div class="pd-20">
                    ...
                    <hr>
                    <a href="index.php?m=MInputBODJ&s=MInputBODJ_add_RJ" class="btn btn-outline-primary">
                    ...
                    <div class="pb-20">
                        <table class="table hover multiple-select-row data-table-export nowrap">
                            ...
                            <tbody>
                                ...
                                $data = $db->query("SELECT * FROM tb_soap WHERE dokter_jaga='$sesi' AND no_rm !='' AND instalasi='Rawat Jalan' ORDER BY tgl_jaga ASC", 0);
                                while($row = $data->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?m=MInputBODJ&s=MInputBODJ_edit_RJ&id=<?= $row['id'] ?>"><span class="btn btn-light btn-sm"><i class="icon-copy ion-edit"></i> </span></a>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <label class="modal-title">Lihat Data Buku Operan Dokter Jaga Rawat Jalan <b><?= $row['nama_pasien']; ?></b></label>
        ...
        <script>
            function deleteData(id) {
                ...
                if (r == true) {
                    location.href = "pages/MInputBODJ/MInputBODJ_proses.php?aksi=hapus_rj&id=" + id;
                }
            }
        </script>