        ...
        <div class="min-height-200px">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <label>Silahkan lakukan inputan SOAP dari BODJ IGD yang dilakukan oleh masing-masing dokter pada pasien IGD.</label> <br><hr>
                                    <label>Klik button <button type="button" class="btn btn-primary">Simpan</button> untuk menambahkan data BODJ IGD</label>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="card-box mb-30">
                <div class="responsive">
                    <div class="pd-20">
                        <form action="pages/MInputBODJ/MInputBODJ_proses.php?aksi=insert_igd" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        <small><i>Jika pasien tidak ada silahkan <b><a href="index.php?m=MInputBODJ&s=MInputBODJ_add_IGD_all">Klik Disini</a></i></b></small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
