        ...
        <div class="min-height-200px">
                        ...
                        <nav aria-label="breadcrumb" role="navigation">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <label>Silahkan lakukan inputan SOAP dari BODJ Hemodialisa yang dilakukan oleh masing-masing dokter pada pasien Hemodialisa.</label> <br><hr>
                                    <label>Klik button <button type="button" class="btn btn-primary">Simpan</button> untuk menambahkan data BODJ Hemodialisa</label>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="card-box mb-30">
                <div class="responsive">
                    <div class="pd-20">
                        <form action="pages/MInputBODJ/MInputBODJ_proses.php?aksi=insert_hd" method="POST" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="input-group">
                                        ...
                                        <small><i>Jika pasien tidak ada silahkan <b><a href="index.php?m=MInputBODJ&s=MInputBODJ_add_HD_all">Klik Disini</a></i></b></small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
