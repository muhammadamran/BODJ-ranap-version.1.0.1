<div id="content" class="content">
    ...
    <a href="index.php?m=bodj&s=bodj">
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/bodj/bodj_proses.php?aksi=insert" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="DPJP" placeholder="DPJP..." required>
                                        <option value="">-- Pilih DPJP --</option>
                                        <option value="dr.ENITA RAHMAWATI K,Sp.PD">dr.ENITA RAHMAWATI K,Sp.PD</option>
                                        <option value="dr.Ria Bandiara,SpPD-KGH">dr.Ria Bandiara,SpPD-KGH</option>
                                        <option value="dr.Lukman Pura,SpPD-KGH">dr.Lukman Pura,SpPD-KGH</option>
                                        <option value="dr.Rama Nusjirwan,Sp.BTKV">dr.Rama Nusjirwan,Sp.BTKV</option>
                                        <option value="dr.Ria Yolanda,Sp.PD">dr.Ria Yolanda,Sp.PD</option>
                                    </select>
                                    <div class="input-group-addon">
                                        <i class="fa fa-user-circle"></i>
                                    </div>
