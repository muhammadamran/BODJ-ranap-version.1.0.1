...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(assets/mode/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Aplikasi Buku Operan Dokter Rawat Inap. <br><small>RS. Khusus Ginjal Ny.R.A. Habibie</small></p>
